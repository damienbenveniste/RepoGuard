"""Diff inspection for generated repo-guard repositories."""
...
from repo_guard.checks.config import int_value, load_repo_guard_toml, str_value, table_value
...
def _apply_agent_rules(
    ...
    if any(_is_agent_rule_file(path) for path in files):
        validations.append("uv run repo-guard check")
