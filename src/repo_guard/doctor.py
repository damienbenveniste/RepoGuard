...
from repo_guard.checks.config import load_toml
from repo_guard.project_config import ProjectConfigError, load_generated_project_config
...
def _generated_project_checks(root: Path) -> tuple[DoctorCheck, ...]:
    ...
    checks = [
        DoctorCheck(
            ...
            ok=True,
            severity="info",
            message="repo-guard.toml parses.",
        ),
        DoctorCheck(
