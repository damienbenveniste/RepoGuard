...
from repo_guard.adapters import adapters_for
from repo_guard.fs import ensure_relative_safe_path, is_within_directory, write_text_safely
...
PACKAGE_TEMPLATE_SPECS = (
    ...
    TemplateSpec("package/repo-guard.toml.j2", "repo-guard.toml"),
